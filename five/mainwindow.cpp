...
MainWindow::MainWindow(QWidget *parent, int type, QString ip) :
    QMainWindow(parent),
    ui(new Ui::MainWindow)
{
    ...
    net = new Net(type,ip);
    player = new Player();
    connect(net,SIGNAL(has_data(QString*)),this,SLOT(rec_data(QString*)));
    connect(net,SIGNAL(has_err(QString)),this,SLOT(error(QString)));
    connect(net,SIGNAL(startGame()),this,SLOT(startGame()));
    if(net->IsListening())
